...
Func CreateGUIConfig()
   ...
   GUICtrlCreateLabel ("Volumn", 380, 123)
   Global $inputVolumn = GUICtrlCreateInput ($Volumn, 430, 120, 30, 20)
...
Func OnOK()
   ...
   $Volumn = Number(GUICtrlRead($inputVolumn))
...
Func OnCancel()
   ...
   GUICtrlSetData($inputVolumn, $Volumn)
EndFunc
...
Func ReadIniFile()
   ...
   $Volumn = Number(IniRead($IniFile, "Config", "Volumn", $Volumn_Default))
...
Func WriteIniFile()
   ...
   IniWrite($IniFile, "Config", "Volumn", $Volumn)
EndFunc